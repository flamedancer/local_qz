...
urlpatterns += patterns('',
    url(r'^ocadmin/',include('apps.ocadmin.urls'),name = "ocadmin"),
)

#基础页面跳转配置
urlpatterns += patterns('apps.views.main',
    url(r'^$','gadget',name = 'gadget'),
    url(r'^subareas_conf/$', 'subareas_conf', name='subareas_conf'),
    url(r'^gadget/$','gadget',name = 'gadget'),
    ...
    url(r'^temporary_credential/$', 'temporary_credential',name = 'temporary_credential'),
    ...
    url(r'^pvp_tutorial/$','pvp_tutorial',name = 'pvp_tutorial'),
