...
STORAGE_CONFIG = {
    "dev":{ #  外网测试服
        ...
        'realtime_pvp_redis':{'host':'10.200.55.32','port':6394,'db':'1'},  # 一组redis 用来记录在线pvp的用户
        ...
        'log_mongodb':{'host':'10.200.55.32','port':27017,'db':'qz_op_db','username':'qzstgdyg','password':'w22cBor99yYh7E3F7'}, # 一个mongodb 用来查询游戏数据
    },
}
