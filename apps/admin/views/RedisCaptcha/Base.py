...
-- Adjusted by Changsen Xu, from OneClick, Inc., ShangHai. 2014/11/9
   Due to original PyCaptcha.Base can't handle nginx+django's multi-server 
   multi-process situation. Python Shelve caused GIL locks, and for faster 
   speed, I think redis is faster than files on hard disk.
...
from apps.admin.views.RedisCaptcha.RedisCaptchaDict import RedisCaptchaDict
...
class PersistentFactory(Factory):
    """Not good for Nginx/Django -- multi-app server, multi-process, 
       met GIL lock problem. 2014/11/14
